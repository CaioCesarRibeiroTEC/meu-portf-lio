                ...
                <MyExperiencesContainer>
                    ...
                    <MyExperiences >
                        <b>
                            ...
                            <ExperiencesLi>
                                ♦ BTCC conexão ao cliente: sac-empresarial, vendas de planos e suporte técnico  – 2018-2024
                            </ExperiencesLi>
                ...
                <DescriptionNav>
                    <DescriptionB>
                        ...
                        <DescriptionP>
                            ...
                            <a href="https://www.linkedin.com/in/paulo-borges-1133341a1/" target="_blank" rel="noreferrer"><b> Paulo Borges </b></a> 
                            atravez do curso <a href="https://www.linkedin.com/company/projeto-profiss%C3%A3o-programador/" target="_blank" rel="noreferrer"><b> Pofissão progrmador </b></a> 
                            da comunidade DCS (desenvolvedores, conexão e sucesso) 
                            esse curso fornece um bom conhecimento em front-end e back-end e priorizando o melhor aprendizado o mundo developer business.  
                        </DescriptionP>

                        <DescriptionP>
                            Eu ja trabalhei como agente call center, uber, gerente de fabrica, suporte de aparelho, tenho cursos de lideranças e 
                            sempre fui bom em trabalho em equipee e sou bastante empenhado.
                        </DescriptionP>

                        <DescriptionP>
                            Em busca de uma vida financeira melhor ingressei no mundo da progrmação e com empenho conclui os desafios e estudo dado pelo 
                            curso profissão programador e me tornei um desnvolvedor.<br/>
                            Utilizo tecnologias como HTML, CSS, JavaScript, TypeScript, React, Next.js, Node.js, MongoDB, PostgreSQL, Styled-components, 
                            Tailwind CSS, Material UI e Shadcn UI, entre outros.
                        </DescriptionP>


                        <DescriptionP>
                            Sou bastante comprometido e tenho vontade de aprender e avançar sempre pois o mundo developer sempre vai caber mais e mais aprendizado e tenho muito a oferecer
